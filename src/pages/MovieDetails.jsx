...
function MovieDetails() {
	...
	const endpoint = `http://www.omdbapi.com/?apiKey=d9d50b24&t=${movie}`;
	...
	useEffect(() => {
		...
		handleMovieDetails();
	}, [movie]); // Ensure movie dependency to refetch when movie param changes
					...
					<div className="flex flex-col md:w-[590px] gap-5 mt-2">
						...
						<div className="flex flex-col gap-1">
							...
							<div className="flex items-center font-black gap-1">
								Ratings: <p className="font-thin">{movieDetails?.imdbRating}</p>
							</div>
							<div className="flex items-center font-black gap-1">
